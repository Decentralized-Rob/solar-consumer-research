  ...
  return (
    ...
    >
      ...
      <section className="info-section">
        ...
        <p>Email addresses are used to respond to submitted questions. State and city information helps identify relevant public resources. Submitted questions are available only to authorized site administrators and service providers needed to deliver the submission notification.</p>
      </section>
      <section className="info-section">
      ...
      <section className="info-section">
        ...
        <p>Supabase stores submitted questions. FormSubmit delivers the notification email to the site team. Cloudflare hosts the site and processes normal web requests. To request access, correction, or deletion of submitted information, use the <Link href="/#questions">private question form</Link> and identify the message as a privacy request.</p>
      </section>
    </InfoPage>
  );
}
