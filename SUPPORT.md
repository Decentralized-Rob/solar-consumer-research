...
Solar Consumer Research is a public-source research tool. It does not provide individual legal advice, case handling, or customer support for solar companies.

## Choose the right route

| Need | Where to go |
| --- | --- |
| An individual solar situation or private research request | Use the private form at [solarcomplaint.com](https://solarcomplaint.com/#questions). Do not post personal details on GitHub. |
...
Do not post contracts, account information, contact details, screenshots, private correspondence, or unsupported accusations in issues, pull requests, or discussions.

See [CONTRIBUTING.md](CONTRIBUTING.md), [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md), and [SECURITY.md](SECURITY.md) for the full project policies.
